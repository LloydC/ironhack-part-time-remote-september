...
function renderWhiteSauce() {
  ...
  const sauceClasses = document.querySelector('.sauce').getAttribute('class');
  console.log(document.querySelector('.sauce').getAttribute('class'))
  if(sauceClasses.includes('sauce-white')){
    //remove it
