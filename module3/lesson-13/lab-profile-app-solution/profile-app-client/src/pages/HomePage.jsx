...
import placeholderProfileImg from '../assets/profile-placeholder.jpeg';
  ...
  return (
    <div>
        ...
        {isLoggedIn && <>
                        ...
                        <img alt={'profile_image'} src={user.image ? user.image : placeholderProfileImg} style={{width: '50px', height: '50px', borderRadius: '75%'}}/>
